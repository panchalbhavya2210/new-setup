	...
	>
		<div class="relative h-full flex lgmin:col-span-3 lgmin:grid lgmin:grid-cols-3 home-grid">
				...
				>
					...
					<defs>
						...
						>
							...
							<stop offset="1" stop-color="#972F2F" stop-opacity="0" id="stop2" />
						</linearGradient>
					</defs>
				</svg>
			</div>
			<div class="relative w-full lgmin:border-x lgmin:border-x-white-opaque lgmin:px-3">
			...
			>
				...
				>
					<path d="M2 130.5V3V0.5L501 2V24L2 130.5Z" fill="url(#paint1_linear_0_1)" />
